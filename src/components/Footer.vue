<template>
  <div class="flex justify-center items-center">
    <div class="h-20 bottom-o py-8 flex">
      <p class="pr-2">&copy; Brenda Franco</p>
      <a class="github" href="https://github.com/brendiuxfranco" target="_blank"
        ><GithubCircle
      /></a>
      <a
        class="facebook"
        href="https://facebook.com/brendiux.franco"
        target="_blank"
        ><Facebook
      /></a>
      <a class="twitter" href="https://twitter.com/tkm93" target="_blank"
        ><Twitter
      /></a>
    </div>
  </div>
